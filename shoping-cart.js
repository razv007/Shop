...
function displayCart() {
  ...
  for(var i in cartArray) {
    var photo="./img/poza_shop"+ cartArray[i].index+".png";
    output += "<tr class='item'>"
      +"<td><div class='buttons'>"
      +"<span class='delete-btn' data-index=" + cartArray[i].index + ">"
      +"<img class='delete-btn-img'src='./img/x.png'>"
      +"</span>"
      +"</td>"
      +"<td><div class='image'>"
      ...
      +"<img src='./img/minus.png'/></button></div></td>"
      +"<td><div class='total-price'>"+cartArray[i].total+" Ron</div></td>"
      +"</div></td></tr>"
  }
  $('.show-cart').html(output);
  $('.subtotal').html(shoppingCart.totalCart());
  $('.total-count').html(shoppingCart.totalCount());
  nr_total=shoppingCart.totalCount();
  total=shoppingCart.totalCart();
  $('.total-cart').html(total+aux);
}
// Delete item button
